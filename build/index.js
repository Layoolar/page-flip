...
class UI {
    ...
    checkTarget(targer) {
        if (!this.app.getSettings().clickEventForward)
            return true;
        if (['a', 'button', 'p', 'span'].includes(targer.tagName.toLowerCase())) {
            return false;
        }
        return true;
    }
